 ...
 *****************************************************************************
   ...
   - V0.1, July 2016: initial version.
...
extern uint8_t AfeClkSel(uint32_t clkSource);
...
extern uint8_t AfeSysClkDiv(AFE_SYSCLKDIV_TypeDef clkDiv);
extern uint8_t AfeAdcClkDiv(uint32_t clkDiv);
extern uint8_t AfeHFOsc32M(uint32_t En);
